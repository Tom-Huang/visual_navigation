...
%我感觉这里不能默认读者已经知道了exercise 5 在干什么，直接说our pipelie is different in 3cases. 不然paper看起来很奇怪，还是得大概介绍一下区别 
...
%另外最好有一个关于optical flow 怎么实现的段落？比如我们调了opencv 的包，用了0.01的参数，之类的？毕竟标题是visual odometry with optical flow, 一直没有提optical flow 怎么实现的，implementaion里应该提一下
